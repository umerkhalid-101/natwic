...
export const Hero: React.FC = () => {
  ...
  return (
    <section id="home" className="relative min-h-screen pt-32 bg-white flex flex-col overflow-hidden">
      ...
      <div className="container mx-auto px-6 md:px-12 mb-6 select-none relative z-10">
        <div className="flex justify-between items-end">
          <MaskedText>
            <h1 className="text-[17vw] font-bold text-black leading-[0.7] tracking-[-0.06em]">
              Natwic
            </h1>
          </MaskedText>
      ...
      >
        ...
        {/* Dynamic Prismatic Animation with New Colors */}
